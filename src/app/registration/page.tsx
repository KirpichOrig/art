        ...
        <div className='max-h-[600px] max-w-[427px] h-full w-full bg-[#181818] rounded-r-[20px] flex flex-col justify-between'>
          ...
          <form action="" className='bg-transparent py-[20px] px-[45px] flex flex-col gap-[24px]'>
            ...
            <div className='bg-transparent flex flex-col gap-[12px]'>
              <input type="text" className='bg-transparent input px-[10px] py-[6px] focus:outline-none text-white' placeholder='имя' />
              ...
              <input type="password" className='bg-transparent input px-[10px] py-[6px] focus:outline-none text-white' placeholder='повторите пароль' />
            </div>
            <button className='py-[4px] border border-white border-solid text-white opacity-[0.9] rounded-[4px]'>зарегистрироваться</button>
